 ...
 *
 * Copyright (C) 2024 Ankit Kumar <ankit.kumar2@infineon.com>
 *
...
#ifndef LIBSIGROK_HARDWARE_CYPRESS_FX10_PROTOCOL_H
#define LIBSIGROK_HARDWARE_CYPRESS_FX10_PROTOCOL_H
...
#define LOG_PREFIX "cypress-fx10"
...
#define MAX_8BIT_SAMPLE_RATE	SR_MHZ(320)
#define MAX_16BIT_SAMPLE_RATE	SR_MHZ(320)
#define MAX_32BIT_SAMPLE_RATE	SR_MHZ(320)
...
struct dev_context {
	const struct cypress_fx10_profile *profile;
	GSList *enabled_analog_channels;
	/*
	 * Since we can't keep track of an Cypress-FX10 device after upgrading
